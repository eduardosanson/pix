...
public class UpdatePixResponseDTO {
    ...
    public UpdatePixResponseDTO() {
    }

    public UpdatePixResponseDTO(String id, PixType pixType, String pixValue, AccountType accountType,
                                Integer agencyNumber, Integer accountNumber, String holderName,
                                String holderLastName, HolderType holderType, LocalDateTime createdAt) {
        this.id = id;
